 ...
 */
class Ville extends \BackOfficeBundle\Entity\Ville implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Ville' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\Ville' . "\0" . 'ville', '' . "\0" . 'BackOfficeBundle\\Entity\\Ville' . "\0" . 'cp'];
        }
